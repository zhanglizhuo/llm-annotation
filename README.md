...
|----------|-----------|----------|
| **Cross-model validation** (10 LLMs across 3 model families) | Qwen3.5-35B-A3B achieves 89.37% on BowTurnHead val; LLaVA-1.5 gets 14.76%. Qwen3.5-27B is the most balanced annotator on TeacherBehavior (52.21%). Rankings are dataset-dependent: no single model is best across all three. | `results/cross_model_validation/` |
...
| — Cross-model validation (10 models) | `results/cross_model_validation/{default,qwen35_*,gemma4_*}/` | JSONL + CSV + JSON |
