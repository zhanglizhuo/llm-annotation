...
selective-routing analysis, and a eleven-model cross-model robustness check
spanning seven model families (Qwen2, Qwen2.5, Qwen3.5, Qwen3.6, LLaVA,
Gemma3, and Gemma4) across 7B--35B parameter scales.
...
reliably annotated. A eleven-model cross-model validation confirms that
