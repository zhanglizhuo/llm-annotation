...
``---'' indicates per-category data was not collected for that model--dataset
combination (overall accuracy for those models is reported in
Table~\ref{tab:crossmodel_overall}).}
