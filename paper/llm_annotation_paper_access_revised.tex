...
Gemma4-31B) substantially improve on \textit{guide} (39--83\%) while
\textit{answer} remains below 23\% universally, identifying a task-level
single-frame observability boundary. Third, a quality-threshold
